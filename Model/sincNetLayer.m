...
properties (Access = private)
    ...
    methods (Access = public)
        ...
        function F = generateSincFilter(layer)
         ...
         function [filters,H,Freq] = freqDomainFilters(layer)
